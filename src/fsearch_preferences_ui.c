...
typedef struct {
    ...
    GtkToggleButton *show_trash_dialog;
...
preferences_ui_get_state(FsearchPreferencesInterface *ui) {
    ...
    new_config->show_trash_dialog = gtk_toggle_button_get_active(ui->show_trash_dialog);
...
preferences_ui_init(FsearchPreferencesInterface *ui, FsearchPreferencesPage page) {
    ...
    ui->show_trash_dialog = toggle_button_get(ui->builder,
                                                       "show_trash_dialog",
                                                       "help_warn_failed_open",
                                                       new_config->show_trash_dialog);
